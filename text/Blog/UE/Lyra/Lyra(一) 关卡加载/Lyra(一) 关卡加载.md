...
![image](image-20260204211955-49jcov8.png)

# 切入

传送点是B_TeleportToUserFacingExperience. 

![image](image-20260204212251-5pkn2al.png)

那显然就是这个胶囊体的Overlap事件触发传送. 进事件图表看一眼, 发现Overlap事件触发了LoadIntoExperience事件. 

![image](image-20260204213735-bix5orz.png)
...
![image](image-20260204231339-mmomiwu.png)
...
![image](image-20260204224331-k4xrbdl.png)

而ActionSet其实也并非新鲜的东西, 其中依旧是GameFeatures和Actions的配置.

![image](image-20260204224716-9cu8vn1.png)
...
![image](image-20260205125854-4nqz7rx.png)

看一下CreateHostingResult的实现:

![image](image-20260205133047-mrzkkkd.png)
...
![image](image-20260205135042-elkiuas.png)
...
![image](image-20260205145910-7ccvpgb.png)
...
>
> ![8977e06991028ef9688d66250456a8c4](8977e06991028ef9688d66250456a8c4-20260205151327-ydeur0s.png)
>
> (以上引用自[UE5 Lyra项目学习（一） 地图加载流程 - Cherry的文章 - 知乎](https://zhuanlan.zhihu.com/p/563434530))

InitGame中, 按注释的说法是先在当前帧初始化startup settings, 所以会在下一帧才执行HandleMatchAssignmentIfNotExpectingOne.

![image](image-20260205151614-4f493bv.png)
...
![image](image-20260205174101-yjaf5r4.png)
...
![image](image-20260205194222-nf41zzd.png)
...
![image](image-20260204162539-cqbdwkd.png)

Lyra用了一个类来实现自定义此设置项: 

![image](image-20260204162623-xuqrw69.png)

用法:

![image](image-20260204162749-jpvc168.png)
